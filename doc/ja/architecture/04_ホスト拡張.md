...
実装: `src/lifecycle.rs` / `src/lifecycle/tracking.rs`。登録: `set_lifecycle` / `lifecycle_from_tracking` / `seed_host_scratch`。用語: [用語集.md](用語集.md) · 方針: [development-principles.md](../development-principles.md) · [EN](../../en/architecture/04_host-extensions.md)

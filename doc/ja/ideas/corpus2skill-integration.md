...
- マッピング: [context-memory-mapping.md](../architecture/09_コンテキストマッピング.md)（**本文は汎用表現のみ**）
- 代替候補との比較: [../architecture/03_記憶層.md](../architecture/03_記憶層.md)（mempalace 経路）／[mempalace-integration.md](mempalace-integration.md)（スタブ）

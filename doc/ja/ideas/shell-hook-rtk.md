...
- 参考: [RTK](https://github.com/rtk-ai/rtk)
...
| crates.io の別 `rtk` | 誤インストール注意（RTK 公式 README を確認） |
...
- [react-implementation.md](../architecture/08_ReAct実装.md) — `run_cmd` パス
- [context-memory-mapping.md](../architecture/09_コンテキストマッピング.md) — Observation 圧縮の層

...
- 関連: [context-memory-mapping.md](../architecture/09_コンテキストマッピング.md)（プロンプトブロック・**本文は汎用表現のみ**）、[react-implementation.md](../architecture/08_ReAct実装.md)（ReAct ループ）
- 原典: [arXiv:2604.21816](https://arxiv.org/abs/2604.21816)
...
- [context-memory-mapping.md](../architecture/09_コンテキストマッピング.md) — system のツールブロックを Phase1/2 に分割した図
- [react-implementation.md](../architecture/08_ReAct実装.md) — `tool_attention` フック位置
